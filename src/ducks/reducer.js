...
const UPDATE_ADDRESS_3 = 'UPDATE_ADDRESS_2';
...
function reducer(state = initialState, action){
    ...
    case UPDATE_LOAN_TYPE:
        return(
            Object.assign({}, state, { loanType: action.payload })
        )

    case UPDATE_PROPERTY_TYPE:
        return(
            Object.assign({}, state, { propertyType: action.payload })
        )
    
    case UPDATE_CITY:
        return(
            Object.assign({}, state, { city: action.payload })
        )

    case UPDATE_PROP:
        return(
            Object.assign({}, state, { propToBeUsedOn: action.payload })
        )

    case UPDATE_FOUND:
        return(
            Object.assign({}, state, { found: action.payload })
        )

    case UPDATE_AGENT:
        return(
            Object.assign({}, state, { realEstateAgent: action.payload })
        )

    case UPDATE_COST:
        return(
            Object.assign({}, state, { cost: action.payload })
        )

    case UPDATE_DOWN_PAYMENT:
        return(
            Object.assign({}, state, { downPayment: action.payload })
        )

    case UPDATE_CREDIT:
        return(
            Object.assign({}, state, { credit: action.payload })
        )
    ...
    case UPDATE_ADDRESS_1:
        return(
            Object.assign({}, state, { addressOne: action.payload})
        )
    case UPDATE_ADDRESS_2:
        return(
            Object.assign({}, state, { addressTwo: action.payload})
        )
    case UPDATE_ADDRESS_3:
        return(
            Object.assign({}, state, { addressThree: action.payload})
        )

    case UPDATE_FIRST:
        return(
            Object.assign({}, state, { firstName: action.payload })
        )

    case UPDATE_LAST:
        return(
            Object.assign({}, state, { lastName: action.payload })
        )
